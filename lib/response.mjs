class Response {
  ...
  /**
   * @type {object}
   * @description Get and Set the Content-Security-Policy header. Note: this property is set as 
   * an object but returns a string
   * @property {object} csp - CSP object
   * @example response.csp = {"default-src": ["self", "example.com"], "script-src": ["scripts.example.com]};
   */
  get csp() {
    return this._csp;
  }
